...
License: CC0
"""
# RECONSTRUCTED (see CLAUDE.md): same damage pattern as the other
# knowledge/ modules. One judgment call: the continuation line of
# recontextualize_silences() arrived flush-left and was realigned
