...
License: CC0
"""
# RECONSTRUCTED (see CLAUDE.md): this file arrived on main with module
# docstring commented out, class bodies flush-left, Markdown fence
# markers embedded, and __name__/__main__ rendered as **name**/**main**.
# Reconstruction preserves the original semantics; only damage was repaired.
