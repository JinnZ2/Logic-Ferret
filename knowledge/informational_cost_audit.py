# ============================================================
# INFORMATIONAL COST AUDIT
# Why false certainty is expensive -- not just thermodynamically,
# but informationally
# ============================================================
#
# Companion module to study_scope_audit. Same epistemic stance:
# treat confident claims as scope-bounded measurements. Different
# angle: where study_scope_audit enumerates the audit LAYERS
# needed to declare scope, this module accounts for the COST
# accumulated when a closed, false model is maintained against
# evidence.
#
# The geocentric case is the worked example: comfort looks cheap
# upfront (simple model), but each anomaly adds an epicycle, and
# each epicycle is a committed lie the institution now has to
# defend. Heliocentrism looks expensive upfront (contradicts
# intuition), but each new measurement fits cleanly. The bill is
# linear, not exponential.
#
# For AI systems: apparent information cost is INVERTED from true
# information cost. A confident closed answer feels cheap but
# accumulates epicycle debt. A scope-bounded uncertain answer
# feels expensive but is compressible and regime-stable.
# ============================================================
